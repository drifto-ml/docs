...
registry like MLflow. This enables Drifto to be a lightweight (but specialized
and powerful) compute system on top of your existing data stack rather than a 
new system that needs a heavy integration and migration.
...
your favorite BI tool like Tableau or Mode, or a dbt pipeline. Drifto is also directly accessible through the Trino CLI.
